...
def main():
    ...
    # 加载图片,音乐,音效.
    background_image     = pygame.image.load(parent_path + r"/image/background.png")
    home_image           = pygame.image.load(parent_path + r"/image/home.png")
    home_destroyed_image = pygame.image.load(parent_path + r"/image/home_destroyed.png")
    
    bang_sound          = pygame.mixer.Sound(parent_path + r"/music/bang.wav")
    bang_sound.set_volume(1)
    fire_sound           = pygame.mixer.Sound(parent_path + r"/music/Gunfire.wav")
    start_sound          = pygame.mixer.Sound(parent_path + r"/music/start.wav")
    start_sound.play()
    ...
    # 敌军坦克出现动画
    appearance_image = pygame.image.load(parent_path + r"/image/appear.png").convert_alpha()
    appearance = []
